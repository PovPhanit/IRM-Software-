...
echo:
echo:
powershell -Command "Write-Host '         =============Login============' -ForegroundColor White"
powershell -Command "Write-Host -NoNewline '          Username  ' -ForegroundColor Cyan"
powershell -Command "Write-Host -NoNewline ': ' -ForegroundColor White"
set /p input=""  

powershell -Command "Write-Host -NoNewline '          Password ' -ForegroundColor Cyan"
...
if %input%==Phanet (
if %password%==3171322 goto :Sucess
)
goto :2
:LOCKOUT
...
@REM =====================
powershell -Command "Write-Host '         =============Login============' -ForegroundColor White"
powershell -Command "Write-Host '              Login Successfully...  ' -ForegroundColor Green"
powershell -Command "Write-Host '-------------------------' -ForegroundColor White"
powershell -Command "Write-Host -NoNewline '=> Enter Confirm Again : ' -ForegroundColor Green"
@REM =======================================End my code =========================================
...
echo:
echo:
call :_color2 %_White% "        " %_Green% "                  Digital Activation License Key"   
...
powershell -Command "Write-Host -NoNewline '             Enter Option  : ' -ForegroundColor Cyan"
choice /C:123450 /N
set _erl=%errorlevel%
...
if %_erl%==1 (
powershell -Command "Write-Host -NoNewline '             License Name  : ' -ForegroundColor Cyan"
    set /p name=""
powershell -Command "Write-Host -NoNewline '             Email         : ' -ForegroundColor Cyan"
    set /p emailLicense=""
    set frz=1&goto :_activate)
goto :MainMenu
...
set "reg=HKCU\SOFTWARE\DownloadManager /v LName /t REG_SZ /d "%emailLicense%"" & call :_rcont
...
set "reg=HKU\%_sid%\SOFTWARE\DownloadManager /v LName /t REG_SZ /d "%emailLicense%"" & call :_rcont
